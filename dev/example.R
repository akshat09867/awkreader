...
agg8 <- aggregated.fread(the.files = rep.int("~/Downloads/diamonds.csv", 2), summarize.with = list(median = list("price", "carat"), sd = list("carat"), sample_size = TRUE, median = list("price")), group.by = c("cut", "color"))
print(agg8)
